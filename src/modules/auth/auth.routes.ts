...
router.post(
  '/register',
  [apiRateLimiters.write, validate(registerSchema)],
...
router.post(
  '/refresh',
  [apiRateLimiters.write, validate(refreshTokenSchema)],
...
router.post(
  '/logout',
  [authenticate, apiRateLimiters.write, validate(refreshTokenSchema)],
